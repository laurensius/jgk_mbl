...
public class DetailMinuman extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detailminuman_activity);
		...
		menu_webview.loadUrl(getResources().getString(R.string.server).toString() + "detail_minuman/" + id);
	}
	...
	class JavaScriptInterface{
	    ...
	    public void terimaPesananMinuman(String jsi_nama_minuman,String jsi_selected_hc, String jsi_harga, String jsi_qty){
	    	String ndb = jigokuPreferences.getString("nama_database", "");
	    	myDB.buatDatabase(ndb);
	    	myDB.isiMinuman(jsi_nama_minuman, jsi_selected_hc, jsi_harga, jsi_qty);
	    	Intent i = new Intent(getApplicationContext(),ListMinuman.class);
	    	startActivity(i);
	    	finish();
	    }

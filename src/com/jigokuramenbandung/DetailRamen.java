...
public class DetailRamen extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detailramen_activity);
		...
		menu_webview.loadUrl(getResources().getString(R.string.server).toString() + "detail_ramen/" + id);
	}
	...
	class JavaScriptInterface{
	    ...
	    public void terimaPesananRamen(String jsi_nama_ramen,String jsi_nama_kuah,String jsi_level,String jsi_harga,String jsi_qty){
	    	...
	    	myDB.isiRamen(jsi_nama_ramen, jsi_nama_kuah, jsi_level, jsi_harga, jsi_qty);
	    	Intent i = new Intent(getApplicationContext(),ListRamen.class);
	    	startActivity(i);
	    	finish();
	    }

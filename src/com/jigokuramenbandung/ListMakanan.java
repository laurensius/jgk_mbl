...
public class ListMakanan extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listmakanan_activity);
		...
		menu_webview.loadUrl(getResources().getString(R.string.server).toString() + "menu_makanan");
	}
	...
	class JavaScriptInterface{
	    ...
	    public void keDetailMakanan(int id){
	    	Intent i = new Intent(getApplicationContext(),DetailMakanan.class);
	    	i.putExtra("id",id);
			startActivity(i);
			finish();
	    }    

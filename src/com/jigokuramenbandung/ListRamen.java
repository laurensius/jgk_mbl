...
public class ListRamen extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listramen_activity);
		...
		menu_webview.loadUrl(getResources().getString(R.string.server).toString() + "menu_ramen");
	}
	...
	class JavaScriptInterface{
	    ...
	    public void keDetailRamen(int id){
	    	Intent i = new Intent(getApplicationContext(),DetailRamen.class);
	    	i.putExtra("id",id);
			startActivity(i);
			finish();
	    }    
